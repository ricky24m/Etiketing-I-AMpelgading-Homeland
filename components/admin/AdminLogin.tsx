...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-400 via-green-500 to-green-600">
      {/* Navbar - sama seperti tampilan utama tapi tanpa menu */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-green-800/95 backdrop-blur-sm shadow-lg">
      ...
      {/* Login Form - dengan padding top untuk navbar */}
        ...
        <div className="max-w-md w-full space-y-8">
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">I'AMpel GADING HOMELAND</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-green-600 hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
              >
                {loading ? (
