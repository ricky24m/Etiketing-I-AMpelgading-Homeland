        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <svg className={`h-5 w-5 text-gray-400 ${showPassword ? 'block' : 'hidden'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {process.env.NODE_ENV === 'development' && (
            <div className="mt-4 p-3 bg-gray-100 rounded text-xs">
              ...
              <p>Username: ampelgadingadmin</p>
              <p>Password: ampelgading11.11</p>
            </div>
          )}
