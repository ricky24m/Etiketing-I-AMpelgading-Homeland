            ...
            {menus.map((m: any) => (
              <tr key={m.id} className="border-b">
                ...
                <td className="py-2 px-3 flex gap-2">
                  <button className="text-blue-600 underline" onClick={() => handleOpen('detail', m)}>Detail</button>
                  <button className="text-green-600 underline" onClick={() => handleOpen('edit', m)}>Update</button>
                  <button className="text-red-600 underline" onClick={() => handleDelete(m.id)}>Hapus</button>
                </td>
              </tr>
            ))}
          </tbody>
